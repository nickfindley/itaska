...
function bootstrap_pagination( \WP_Query $wp_query = null, $echo = true ) {
	...
	$pages = paginate_links( [
			...
			'mid_size'     => $mid_size,
			'prev_next'    => true,
			'prev_text'    => __( '<i class="fas fa-caret-left"></i>&nbsp;Previous<span class="pagination-expanded-text"> Page</span>' ),
			'next_text'    => __( 'Next<span class="pagination-expanded-text"> Page</span>&nbsp;<i class="fas fa-caret-right"></i>' ),
			'add_args'     => false,
			'add_fragment' => ''
		]
	);
