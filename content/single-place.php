...
if ( get_field( 'dutchtown_cid' ) || get_field( 'cherokee_street' ) || ( get_field( 'dutchtown_passport' ) )  && ( $today >= $start_date ) && ( $today <= $end_date ) ) : ?>
    ...
    <div class="main-content-container container">
        ...
        <div class="place-map">
            <?php
                ...
                $shortcode = '[map addr="' . $wp_address .'"]' . get_the_title() . '[/map]';
